...
institutionen = []
institutionen[institutionen.length] = ['Infos Neumitglieder',	0]
...
institutionen[institutionen.length] = ['Initiativen-Suche',				0]
...
institutionen[institutionen.length] = ['Agora (Kanzleramtsforum) ',			'index.php3?position=11100&ini_id=4242']
...
institutionen[institutionen.length] = ['dol2day-Verein',						0]
institutionen[institutionen.length] = ['dol2day e.V.',					'index.php3?position=14000&ini_id=1423']

institutionen[institutionen.length] = ['dol2day Institutionen',			0]
institutionen[institutionen.length] = ['Politisches Duell',				'index.php3?position=25100']
institutionen[institutionen.length] = ['dol2day-Gesetzbuch',			'index.php3?position=8500']
...
institutionen[institutionen.length] = ['Sonstiges',						0]
institutionen[institutionen.length] = ['Dol-Statistiken',				'index.php3?position=600']
institutionen[institutionen.length] = ['Dol-Monitor',				'index.php3?position=710']
